...
// Create GET route to render stags page.
// In this case, assigning a path of "/" actually gives a path of "/stags/", as the root by default is "/stags".
...
router.get("/", async (req, res) => {
        try {
                ...
                res.render("stags", { people: people , staglists: staglists})
        } catch {
